...
<body>
    <form action="{{ route('sach.store') }}"class="form-horizontal" method="post">
        <h1>them sach</h1>
        @csrf
        <table class="table table-striped"style="width:1000px;height:700px,">
            <tr>
                ...
                <th>
                    tac gia: <select name="tac_gia" class="form-control"style="width:300px">
                ...
                <th>
                    the loai: <select name="the_loai" id=""class="form-control"style="width:300px">
            ...
            <tr>
                <th style="width:500px;height:50px">
                    so trang : <input type="number"name='so_trang' class="form-control" style="width:100px; ">
                    @error('so_trang')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
                </th>
                <th>
                    nam xuat ban : <input type="number"name='nam_xuat_ban' class="form-control" style="width:100px">
                    @error('nam_xuat_ban')
                        <p style="color:red">{{ $message }}</p>
                    @enderror
